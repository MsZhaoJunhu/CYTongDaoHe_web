            ...
            <div v-for='(item,partIndex) in progressLinePart' class='progressLine-part'>
                <div class='progress-line-item' v-for='(it,index) in item' :key='it.id' :class='`it${index+1}`'>
                    ...
                    <div class='key-event '>
                        ...
                        <p>
                            <span
                                style='color:#999999;text-decoration: underline;cursor: pointer;'>{{it.dowload[0]}}</span>
                            <span style='color:#9e0100;margin-left:15px;cursor: pointer;'>{{it.dowload[1]}}</span>
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        data() {
            return {
                progressLine: simData.serverGuarantee,
...
<style scoped>
    ...
    .progressLine-part:nth-last-of-type(1) .progress-line-item:nth-last-of-type(1) .key-event:nth-last-of-type(1) {
        color: #999999;
    }

    .progressLine-part:nth-last-of-type(1) .progress-line-item:nth-last-of-type(1) .key-event:nth-last-of-type(1) .afford-money {
        color: #fff;
        background: #999999;
    }

    .progressLine-part:nth-last-of-type(1) .progress-line-item:nth-last-of-type(1) .key-event:nth-last-of-type(1) .event-step {
        color: #999999;
    }
    /* 奇数行如果单行数量不足4个进行对齐处理 */
    ...
    .progressLine-part:nth-of-type(even):nth-last-of-type(1) .progress-line-item:nth-last-of-type(2) .connect-line {
        background: #dddddd 
    }

    .progressLine-part:nth-of-type(odd):nth-last-of-type(1) .progress-line-item:nth-last-of-type(2) .connect-line {
        background: #dddddd 
    }
