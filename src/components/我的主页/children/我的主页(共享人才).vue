        ...
        <div class="bjs">
            ...
            <div class="main">
                ...
                <div class="content">
                    ...
                    <my-project :zxzd="zxzd" :rclp="rclp" :zxfz="zxfz"></my-project>
...
<script>
    import myInfoP from '../components/我的信息(共享人才)'
    import myAccount from '../components/我的账户'
    import myProject from '../components/我的项目(共享人才)'
    ...
    import { getConsultant } from "@/components/api/api";
export default {
    name:'talent-member',
    components: {
            myInfoP,
    ...
    mounted() {
        ...
        // 查询咨询主导列表
        getConsultant({corpId:user.roleId,consultantType:"咨询主导"}).then(res => {
            if (res.data.code === 200) {
                this.zxzd=res.data.data;
            }
        });
        getConsultant({corpId:user.roleId,consultantType:"人才猎聘"}).then(res => {
            if (res.data.code === 200) {
                this.rclp=res.data.data;
            }
        });
        getConsultant({corpId:user.roleId,consultantType:"咨询辅助"}).then(res => {
            if (res.data.code === 200) {
                this.zxfz=res.data.data;
            }
        });
    },
}
