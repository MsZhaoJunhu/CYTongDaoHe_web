<template>
  ...
  <div class="包裹">
    ...
    <xfc></xfc>
    <div class="banner">
      <img src="../../assets/imgs/zxsd_banner.png"
           alt="行业最新信息及相关公司活动" />
      <div class="text">
        <p>最近我们在干什么？</p>
        <h1>行业最新信息及相关公司活动</h1>
      ...
      <div class="content">
        <template>
          <router-link v-for="(item,index) in newList"
                       :key="index"
                       :to='{path:"/zxsdinside",query:{"newsId":item.newsId,"newsType":newsType}}'
                       class="article">
...
export default {
  ...
  watch: {
    ...
    key (value) {
      console.log(value)
      this.newsType = this.index_title = value;
    }
  },
  mounted () {
    this.getNews();
...
.xlm_erz > span:first-child > a:first-child {
  color: #9e0100;
}
.content {
  display: flex;
