      ...
      <div class="contract_details_all_content">
        ...
        <div>
          ...
          <div class="contract_details_all_content_changeContent">
            <!-- 填写范本 -->
            <div class="contract_div_con"
                 @click="clickToContracts">
            ...
            <div class="contract_div_arr"
              ...
              <div>
                ...
                <div class="bottom3Img">
                  <div @click="clickToPre(item.contractId)" :class="">
...
export default {
  ...
  methods: {
    sizeChange (val) {
      getMyContract(2, { "pageSize": 9, "pageNum": val }).then(res => {
    ...
    // mounted 方法
    preMounted () {
      getMyContract(2, { "pageSize": 9, "pageNum": 1 }).then(res => {
        if (res.data.code == 200) {
          this.contractArr = res.data.data.records
          this.totals = res.data.data.total
        }
    ...
    clickToContract (id) {
      ...
      if(user.role==1){
        this.$router.push({ path: '/fun/gysUpdateContract', query: { "id": id } })
      }
    },
    clickToContracts () {
      this.$router.push('/fun/gysFillSignContract')
    },
    // 多选
    ...
    // 预览
    clickToPre (id) {
      this.$router.push({ path: '/fun/gysPreviewContract', query: { "id": id } })
    }
  },
}
</script>
...
<style>
.contract_footer_pagination .el-pagination.is-background .el-pager li {
  cursor: pointer;
}
.contract_footer_pagination
