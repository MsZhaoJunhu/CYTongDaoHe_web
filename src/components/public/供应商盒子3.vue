<template>
  ...
  <div class="box"
    ...
    <router-link :to="boxUrl">
      <div class="img">
        <img src="../../assets/imgs/khjz/sad.png"
             alt="">
      </div>
      <div class="info"
           :style="boxTags==null?'flex-wrap:wrap':'flex-wrap:unset'">
        <div>
          <h4>{{boxName}}</h4>
          <p class="tjd"
        ...
        <span class="posi">
          <img src="@/assets/imgs/jingdian.png"
               alt="">
        </span>
      </div>
    </router-link>
    <div v-if="boxTags!=null">
      <p class="tab_title">
        <span :class="showTab?'selected':''"
              @click="change(true)">案例标签</span>
      </p>
      <div class="change">
        <div v-show="showTab"
             class="tag_box">
